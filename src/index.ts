...
const token = location.hostname === "localhost" ?
    "jJtubY5fkvzAdU6yLxfK58UnTn_lPLCd" : "prod.url_sdk_token";
...
// console.log(model.getObjectByName('Wolf3D_Outfit_Top'))
console.log(modelMap["onesie"])
