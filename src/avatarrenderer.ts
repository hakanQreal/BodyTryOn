...
export class AvatarRenderer extends PoseRenderer {
    ...
    async setOutfit(url: string, outfit?: OutfitParams) {
        ...
        const teeTexture = new three.TextureLoader().load("1024_seamless_V2 (1).png")
        const teeAlphaTexture = new three.TextureLoader().load("Daleware_UV_alpha (1).jpg")
        this.model.getObjectByName('Wolf3D_Outfit_Top').material.map = teeTexture
        // this.model.getObjectByName('Wolf3D_Outfit_Top').material.transparent = true
        // this.model.getObjectByName('Wolf3D_Outfit_Top').material.alphaMap  =  teeAlphaTexture
        // console.log(this.model.getObjectByName('Wolf3D_Outfit_Top').material)
